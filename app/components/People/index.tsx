            ...
            <div className="mx-auto max-w-7xl px-6">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1 pt-10 lg:pt-32 lg:mt-20'>
                    ...
                    <div className='col-span-6 flex flex-col justify-evenly lg:pl-24 mt-10 lg:mt-0'>
                        ...
                        <h3 className='text-black text-lg font-normal text-center lg:text-start lh-173 opacity-75 pt-5 lg:pt-0'>Our suite of products is meticulously crafted to enhance the private, shared space of couples in the digital realm. From secure messaging platforms that prioritize your privacy to collaborative productivity tools designed for seamless teamwork, we are dedicated to creating a digital sanctuary for couples.</h3>
