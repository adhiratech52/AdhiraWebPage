            ...
            <div className="mx-auto max-w-7xl md:pt-5 pt-20 sm:pb-24 px-6">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12'>
                    ...
                    <div className='col-span-7 flex flex-col justify-evenly relative'>
                        ...
                        <h1 className='text-midnightblue  md:text-5xl text-2xl w-100 text-center lg:text-start font-semibold lh-100 pt-5'>Welcome To Adhira! </h1>
                        <h3 className='text-black opacity-75 text-xl font-bold text-center lg:text-start pt-8'>We are a group of Software Professionals , building Entrprise and Customer Level Software Products   </h3>
